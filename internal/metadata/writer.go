...
func WriteMP4Tags(trackPath, lrc string, meta *structs.AutoGenerated, trackNum, trackTotal int) error {
	...
	if core.Dl_atmos {
		...
		if utils.Contains(meta.Data[0].Relationships.Tracks.Data[index].Attributes.AudioTraits, "hi-res-lossless") {
			qualityTag = utils.FormatQualityTag("Hi-Res Lossless")
		} else if utils.Contains(meta.Data[0].Relationships.Tracks.Data[index].Attributes.AudioTraits, "lossless") {
